...
import org.mobile.gqz.db.sqlite.CursorUtils;
import org.mobile.gqz.db.sqlite.DbModelSelector;
import org.mobile.gqz.db.sqlite.Selector;
import org.mobile.gqz.db.sqlite.SqlInfo;
import org.mobile.gqz.db.sqlite.SqlInfoBuilder;
import org.mobile.gqz.db.sqlite.WhereBuilder;
import org.mobile.gqz.db.table.DbModel;
...
import org.mobile.gqz.utils.IOUtils;
...
public class GQZDb {
	 ...
	 * key: dbName
	 */
	private static HashMap<String, GQZDb> daoMap = new HashMap<String, GQZDb>();
	...
	private GQZDb(DaoConfig config) {
		if (config == null) {
	...
	private synchronized static GQZDb getInstance(DaoConfig daoConfig) {
		GQZDb dao = daoMap.get(daoConfig.getDbName());
		if (dao == null) {
			dao = new GQZDb(daoConfig);
	...
	public static GQZDb create(Context context) {
		DaoConfig config = new DaoConfig(context);
		return getInstance(config);
	}

	public static GQZDb create(Context context, String dbName) {
		DaoConfig config = new DaoConfig(context);
		config.setDbName(dbName);
		return getInstance(config);
	}

	public static GQZDb create(Context context, String dbDir, String dbName) {
		DaoConfig config = new DaoConfig(context);
	...
	public static GQZDb create(Context context, String dbName, int dbVersion,
	...
	public static GQZDb create(DaoConfig daoConfig) {
		return getInstance(daoConfig);
	}

	public GQZDb configDebug(boolean debug) {
		this.debug = debug;
		return this;
	}

	public GQZDb configAllowTransaction(boolean allowTransaction) {
	...
	public interface DbUpgradeListener {
		public void onUpgrade(GQZDb db, int oldVersion, int newVersion);
	}
