...
import org.mobile.gqz.utils.DensityUtils;
 ...
 */
public class GQZInject {

	private GQZInject() {
	}

	private static class ClassHolder {
		private static final GQZInject instance = new GQZInject();
	}
	 ...
	 * @return 本类的对象
	 */
	public static GQZInject create() {
	...
	public static void toast(String msg) {
		try {
			toast(GQZActivityStack.create().topActivity(), msg);
		} catch (Exception e) {
		}
	}
	...
	public static void toast(int resId) {
		try {
			toast(GQZActivityStack.create().topActivity(), resId);
		} catch (Exception e) {
		}
	}
	...
	public static void longToast(String msg) {
		try {
			longToast(GQZActivityStack.create().topActivity(), msg);
		} catch (Exception e) {
		}
	}
	...
	public void getExitDialog(final Context context) {
		...
		builder.setPositiveButton("确定", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
				GQZActivityStack.create().AppExit(context);
			}
		});
		builder.create();
		builder.show();
