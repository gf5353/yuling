...
public class PauseOnScrollListener implements OnScrollListener {
     ...
     * Constructor
     *
     * @param taskHandler   {@linkplain GQZBitmap} instance for controlling
     * @param pauseOnScroll Whether {@linkplain GQZBitmap#pause() pause loading} during touch scrolling
     * @param pauseOnFling  Whether {@linkplain GQZBitmap#pause() pause loading} during fling
     */
