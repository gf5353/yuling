...
package org.mobile.gqz.bitmap.core;
...
import org.mobile.gqz.bitmap.factory.BitmapFactory;
import org.mobile.gqz.cache.FileNameGenerator;
import org.mobile.gqz.cache.LruDiskCache;
import org.mobile.gqz.cache.LruMemoryCache;
...
public class BitmapCache {
            ...
            if (globalConfig.isDiskCacheEnabled() && (mDiskLruCache == null || mDiskLruCache.isClosed())) {
                ...
                if (diskCacheDir.exists() || diskCacheDir.mkdirs()) {
                    ...
                    try {
                        ...
                        GQZLog.debug("create disk cache success");
                    } catch (Throwable e) {
                        mDiskLruCache = null;
                        GQZLog.debug("create disk cache error", e);
                    }
                }
            }
        }
    ...
    public Bitmap downloadBitmap(String uri, BitmapDisplayConfig config, final GQZBitmap.BitmapLoadTask<?> task) {
