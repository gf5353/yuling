...
import org.mobile.gqz.http.callback.DefaultHttpRedirectHandler;
import org.mobile.gqz.http.callback.FileDownloadHandler;
import org.mobile.gqz.http.callback.HttpRedirectHandler;
import org.mobile.gqz.http.callback.RequestCallBack;
import org.mobile.gqz.http.callback.RequestCallBackHandler;
import org.mobile.gqz.http.callback.StringDownloadHandler;
    ...
    private ResponseInfo<T> sendRequest(HttpRequestBase request) throws HttpException {
        ...
        while (true) {
            ...
            try {
                ...
                if (GQZHttp.sHttpCache.isEnabled(requestMethod)) {
                    String result = GQZHttp.sHttpCache.get(requestUrl);
                    if (result != null) {
        ...
        if (statusCode < 300) {
            ...
            if (entity != null) {
                ...
                if (isDownloadingFile) {
                    ...
                    if (GQZHttp.sHttpCache.isEnabled(requestMethod)) {
                        GQZHttp.sHttpCache.put(requestUrl, (String) result, expiry);
                    }
                }
            }
