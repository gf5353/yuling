...
import org.mobile.gqz.db.annotation.Check;
import org.mobile.gqz.db.annotation.NotNull;
import org.mobile.gqz.db.annotation.Transient;
import org.mobile.gqz.db.annotation.Unique;
import org.mobile.gqz.db.converter.ColumnConverter;
import org.mobile.gqz.db.converter.ColumnConverterFactory;
import org.mobile.gqz.db.sqlite.FinderLazyLoader;
import org.mobile.gqz.db.sqlite.ForeignLazyLoader;
import org.mobile.gqz.db.annotation.Column;
import org.mobile.gqz.db.annotation.Id;
import org.mobile.gqz.db.annotation.Foreign;
import org.mobile.gqz.db.annotation.Finder;
...
public class ColumnUtils {
	...
	public static Method getColumnGetMethod(Class<?> entityType, Field field) {
		...
		if (getMethod == null) {
			...
			try {
				...
				GQZLog.debug(methodName + " not exist");
			}
		}
	...
	public static Class<?> getForeignEntityType(
			org.mobile.gqz.db.table.Foreign foreignColumn) {
	...
	public static Class<?> getFinderTargetEntityType(
			org.mobile.gqz.db.table.Finder finderColumn) {
