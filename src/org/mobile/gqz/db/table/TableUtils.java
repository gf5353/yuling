...
import org.mobile.gqz.db.annotation.Table;
...
public class TableUtils {
	 ...
	 * key: entityType.name
	 */
	private static ConcurrentHashMap<String, org.mobile.gqz.db.table.Id> entityIdMap = new ConcurrentHashMap<String, org.mobile.gqz.db.table.Id>();

	/* package */
	static synchronized org.mobile.gqz.db.table.Id getId(Class<?> entityType) {
		if (Object.class.equals(entityType)) {
		...
		org.mobile.gqz.db.table.Id id = new org.mobile.gqz.db.table.Id(
	...
	private static String getPrimaryKeyFieldName(Class<?> entityType) {
		org.mobile.gqz.db.table.Id id = getId(entityType);
