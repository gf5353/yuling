 ...
 * @version 1.1
 */
final public class GQZActivityStack {
    private static Stack<I_Activity> activityStack;
    private static final GQZActivityStack instance = new GQZActivityStack();

    private GQZActivityStack() {
    }

    public static GQZActivityStack create() {
        return instance;
    }
