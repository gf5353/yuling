package org.example.yulin.ui.view.city;
...
public class MyLetterAlistView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 0; i < b.length; i++) {
			...
			paint.setTextSize(res.getDimension(R.dimen.text_size_micro));
			// 选中的状态
			if (i == choose) {
				paint.setColor(Color.parseColor("#3399ff"));
				paint.setTextSize(res.getDimension(R.dimen.text_size_small));
