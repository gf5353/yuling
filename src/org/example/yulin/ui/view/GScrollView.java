...
public class GScrollView extends ScrollView {
	...
	private GHeader headerView;
	private GFooter footerView;
	...
	private void addheaderView() {
		headerView = new GHeader(mContext);
	...
	private void addfooterView() {
		footerView = new GFooter(mContext);
